  ...
  // we want to test the function that is calling the external service.
    ...
    describe('and there are records in the sample data', () => {
      ...
      it('returns a list of records', done => {
        client.geticpclient((error,response)=>{
    ...
    describe('and there is an record in the data with that ID', () => {
      before(() => provider.addInteraction({
        state: 'Has a record with ID '+expectedRecords[0]['clientNumber'],
        uponReceiving: 'a request for a record with ID '+expectedRecords[0]['clientNumber'],
        withRequest: {
          method: 'GET',
          path: BASE_PATH+'/'+expectedRecords[0]['clientNumber']
        },
        willRespondWith: {
          status: 200,
          headers: {
      ...
      it('returns the record', done => {
        client.geticpclientById(expectedRecords[0]['clientNumber'],(error,response)=>{
          var parsedData = JSON.parse(response.body);
          expect(parsedData).to.have.deep.property('clientNumber', expectedRecords[0]['clientNumber']);
    ...
    describe('and there no records in the database', () => {
      ...
      it('returns a 404', done => {
        client.geticpclientById('NonExisting',(error,response)=>{
      ...
      describe('and there is a record in the data with that ID', () => {
        before(() => provider.addInteraction({
          state: 'Has a record with ID '+expectedRecords[0]['clientNumber'],
          uponReceiving: 'a request to update a record with ID '+expectedRecords[0]['clientNumber'],
          withRequest: {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json'
        ...
        it('returns the updated record', done => {
          client.puticpclient(expectedRecords[0]['clientNumber'], expectedRecords[0], (error,response)=>{
            var parsedData = JSON.parse(response.body);
            expect(parsedData).to.have.deep.property('clientNumber', expectedRecords[0]['clientNumber']);
            done();
          })
      ...
      describe('and there no records in the database with that ID', () => {
        ...
        it('returns a 404', done => {
          client.puticpclient('NonExisting', expectedRecords[0], (error,response)=>{
            expect(response.statusCode).to.be.eql(404);
            done();
          })
        })
      ...
      describe('and the record abides by the required schema', () => {
        ...
        it('returns the newly added record', done => {
          client.posticpclient(expectedRecords[0],(error,response)=>{
            var parsedData = JSON.parse(response.body);
            expect(parsedData).to.have.deep.property('clientNumber', expectedRecords[0]['clientNumber']);
            done();
          });
      ...
      describe('and the record is invalid with respect to the schema', () => {
        ...
        it('returns 400 error', done => {
          client.posticpclient({ 'dummyKey': 'dummyValue' },(error,response)=>{
      ...
      delete semiRecord['clientNumber'];
      describe('and there is an record in the data with that ID', () => {
        before(() => provider.addInteraction({
          state: 'Has a record with ID '+expectedRecords[0]['clientNumber'],
          uponReceiving: 'a request to semi-update a record with ID '+expectedRecords[0]['clientNumber'],
          withRequest: {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json'
        ...
        it('returns the updated record', done => {
          client.patchicpclient(expectedRecords[0]['clientNumber'], semiRecord, (error,response)=>{
            var parsedData = JSON.parse(response.body);
            expect(parsedData).to.have.deep.property('clientNumber', expectedRecords[0]['clientNumber']);
            done();
          })
      ...
      describe('and there no records in the database with that ID', () => {
        ...
        it('returns a 404', done => {
          client.patchicpclient('NonExisting', semiRecord, (error,response)=>{
            expect(response.statusCode).to.be.eql(404);
            done();
          })
        })
      ...
      describe('and there is a record in the data with that ID', () => {
        before(() => provider.addInteraction({
          state: 'Has a record with ID '+expectedRecords[0]['clientNumber'],
          uponReceiving: 'a request to delete a record with ID '+expectedRecords[0]['clientNumber'],
          withRequest: {
            method: 'DELETE',
            path: BASE_PATH+'/'+expectedRecords[0]['clientNumber']
          },
        ...
        it('returns 204', done => {
          client.deleteicpclient(expectedRecords[0]['clientNumber'], (error,response)=>{
      ...
      describe('and there no records in the database with that ID', () => {
        ...
        it('returns a 404', done => {
          client.deleteicpclient('NonExisting', (error,response)=>{
            expect(response.statusCode).to.be.eql(404);
            done();
          })
        })
